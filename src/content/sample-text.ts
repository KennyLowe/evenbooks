 ...
 *
 * Public domain. Sourced from the USF Lit2Go edition of "The Works of Edgar
 * Allan Poe" (Lit2Go ID 5314), which republishes the 1903 collected edition.
 * https://etc.usf.edu/lit2go/147/the-works-of-edgar-allan-poe/5314/the-tell-tale-heart/
 *
 * Whitespace normalised at build: runs of internal whitespace collapsed to
 * single spaces; paragraph boundaries preserved as \n\n; HTML entities decoded.
 */

export type BookId = "sample";
